...
export const EXPENSE_BREAKDOWN: ExpenseCategory[] = [
  ...
  },
  {
    ...
    Icon: Plane,
    bgClass: 'bg-cat-teal',
    strokeClass: 'stroke-cat-teal',
    iconBg: 'bg-cat-teal/15',
    iconColor: 'text-cat-teal',
    borderClass: 'border-cat-teal',
    chartBg: 'bg-cat-teal/60',
  },
  {
    title: 'Доставка еды',
    ops: 18,
    amount: 142320,
    Icon: ShoppingBag,
    bgClass: 'bg-cat-amber',
    strokeClass: 'stroke-cat-amber',
    iconBg: 'bg-cat-amber/15',
    iconColor: 'text-cat-amber',
    borderClass: 'border-cat-amber',
    chartBg: 'bg-cat-amber/60',
  },
  {
    title: 'Путешествия и туры',
    ops: 2,
    amount: 112000,
    Icon: Briefcase,
    bgClass: 'bg-success',
...
export const INCOME_BREAKDOWN: ExpenseCategory[] = [
  ...
  },
  {
    ...
    Icon: Laptop,
    bgClass: 'bg-cat-blue',
    strokeClass: 'stroke-cat-blue',
    iconBg: 'bg-cat-blue/15',
    iconColor: 'text-cat-blue',
    borderClass: 'border-cat-blue',
    chartBg: 'bg-cat-blue/60',
  },
  {
    title: 'Инвестиции',
    ops: 6,
