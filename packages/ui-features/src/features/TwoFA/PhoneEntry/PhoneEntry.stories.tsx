  ...
  args: {
    ...
    policy: (
      <div className={'text-xs'}>
        Нажимая кнопку, вы соглашаетесь на обработку и передачу данных в соответствии с политикой оператору услуг
        информационного обмена РОЛЛАУТ в целях запуска идентификации банком
      </div>
    ),
    buttonText: 'Дальше',
  },
